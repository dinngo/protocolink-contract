...
import {SparkFlashLoanCallback, IAaveV3FlashLoanCallback, IAaveV3Provider} from 'src/callbacks/SparkFlashLoanCallback.sol';

contract SparkFlashLoanCallbackTest is Test {
    IAaveV3Provider public constant sparkProvider = IAaveV3Provider(0x02C3eA4e34C0cBd694D2adFa2c690EECbC1793eE);
    ...
    function setUp() external {
        ...
        flashLoanCallback = new SparkFlashLoanCallback(router, address(sparkProvider), 0);
        ...
        vm.label(address(flashLoanCallback), 'SparkFlashLoanCallback');
        vm.label(address(sparkProvider), 'SparkProvider');
    ...
    function testCannotHaveInvalidBalance() external {
        ...
        // Execute
        vm.startPrank(sparkProvider.getPool());
